import type { ChartDoc, Placement, SymbolDef, StitchLine } from '@dimcraft/core/model/types'
import { placementCorners, placementTransform, cornersBBox, unionBBox, type BBox } from '@dimcraft/core/geometry/transform'
